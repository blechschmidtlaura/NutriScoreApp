public class NutriScore {
    ...
    public static int nutriScore(int energie, double zucker, double gesFettsaeuren, double natrium, int fruechteGemuese, double ballaststoffe, double eiweiss) {
        ...
        if (punkte >= 11 && (fruechteGemuese >= -4 && fruechteGemuese <= -1)) {
            return energieScore.get(energie) + zuckerScore.get((float) zucker) + gesFettsaeurenScore.get((float) gesFettsaeuren) + natriumScore.get((float) natrium) + fruechteGemueseScore.get(fruechteGemuese) + ballaststoffeScore.get((float) ballaststoffe);
        }
        return energieScore.get(energie) + zuckerScore.get((float) zucker) + gesFettsaeurenScore.get((float) gesFettsaeuren) + natriumScore.get((float) natrium) + fruechteGemueseScore.get(fruechteGemuese) + ballaststoffeScore.get((float) ballaststoffe) + eiweissScore.get((float) eiweiss);
    }
}
